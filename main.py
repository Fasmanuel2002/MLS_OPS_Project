...
def main():
    ...
    parser_terminal.add_argument("--checkpoint_dir", type=str, default="models")
    parser_terminal.add_argument("--lr", type=float, default=2e-5)
    parser_terminal.add_argument("--batch_size", type=int, default=32)
    parser_terminal.add_argument("--weight_decay", type=float, default=0.0)
    args_model = parser_terminal.parse_args()
    L.seed_everything(42)
